...
<footer class="text-text-light bg-red-1 flex flex-col lg:flex-row flex-wrap items-start justify-between gap-y-4 w-full py-12 px-12 md:px-20 xl:px-24 xl:py-16">
  ...
  <div class="flex flex-wrap gap-x-12 gap-y-8">
    ...
    <div class="flex flex-col">
      ...
      <ul class="flex flex-col gap-2">
        <li><a href="">{m.footer_digital_autonomy()}</a></li>
        <li><a href="">{m.footer_4_rule()}</a></li>
        <li><a href="">{m.footer_inclusivity()}</a></li>
        <li><a href="">{m.footer_end_bsa()}</a></li>
        <li><a href="">{m.footer_protect_protesting()}</a></li>
      </ul>
    </div>
    <div class="flex flex-col gap-2">
      <h2>{m.footer_people()}</h2>
      <ul class="flex flex-col gap-2">
        <li><a href="/our-people#u_council">{m.footer_ucouncil()}</a></li>
        <li><a href="/our-people#beta">{m.footer_beta()}</a></li>
        <li><a href="/our-people#gw">{m.footer_gw()}</a></li>
        <li><a href="/our-people#rebo">{m.footer_rebo()}</a></li>
        <li><a href="/our-people#fsw">{m.footer_fsw()}</a></li>
      </ul>
    </div>
  </div>
</footer>
