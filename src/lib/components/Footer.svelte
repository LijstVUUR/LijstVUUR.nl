...
<footer class="text-text-light bg-red-1 flex flex-col xl:flex-row flex-wrap items-start justify-between gap-4 w-full py-12 px-12 md:px-20 xl:px-24 xl:py-16">
  ...
  <div class="flex flex-wrap gap-x-12 gap-y-8">
    ...
    <div class="flex flex-col gap-2">
      ...
      <ul class="flex flex-col gap-2">
        <li><a href={localizeHref("/our-people#u_council")}>{m.footer_ucouncil()}</a></li>
        <li><a href={localizeHref("/our-people#beta")}>{m.footer_beta()}</a></li>
        <li><a href={localizeHref("/our-people#gw")}>{m.footer_gw()}</a></li>
        <li><a href={localizeHref("/our-people#rebo")}>{m.footer_rebo()}</a></li>
