...
<Block>
  <div class="people group relative rounded-md overflow-hidden flex flex-col items-center py-8 md:py-16 px-6 lg:px-12 md:px-8 gap-8 bg-primary lg:bg-secondary">
    ...
    <div class="flex flex-col lg:gap-6 items-center relative z-10">
      ...
      <div class="relative inline-block rounded text-base gap-[6px] bg-secondary text-text-dark uppercase md:bg-primary md:text-text-light group-hover:bg-secondary group-hover:text-text-dark">
    ...
    <div bind:this={galleryPeople} class="w-full lg:w-fit flex gap-8 overflow-scroll [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] relative z-10">
    ...
    <div class="flex w-full lg:w-fit items-center justify-between relative z-10">
      ...
      <ButtonLink class="anim h-full lg:bg-primary lg:text-text-light group-hover:bg-secondary group-hover:text-text-dark transition-all" size="small" colour="secondary" href={localizeHref("/our-people")}>
        <p class="font-medium">{m.home_ourpeople_button()}</p>
      </ButtonLink>
